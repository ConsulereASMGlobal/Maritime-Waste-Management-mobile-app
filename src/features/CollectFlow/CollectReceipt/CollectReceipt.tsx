...
const CollectReceipt = ({ route }) => {
  ...
  return (
    ...
    >
      ...
      {loading ? (
        <View
          style={{ height: "100%", backgroundColor: colors.backgroundColor }}
        >
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={styles.mainContainer}>
            <View style={styles.sellerContainer}>
              ...
              <TextField style={styles.grayText}>
                Waste Source :{" "}
                {recieptData?.[0]?.orderDetails[0]?.items[0]?.remark || "N/A"}
              </TextField>
            </View>
            <Spacer spacing={10} />
